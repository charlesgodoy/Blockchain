...
class Blockchain(object):
    ...
    def valid_proof(block_string, proof):
        ...
        # TODO: Change back to six digits
...
@app.route('/mine', methods=['POST'])                                       # change to post cause now being sent by client
def mine():
    # We run the proof of work algorithm to get the next proof...
    # proof = blockchain.proof_of_work(blockchain.last_block)               # removed proof_of_work cause method was commented out
    ...
    proof = values['proof']
    if blockchain.valid_proof(block_string, proof) is True:
